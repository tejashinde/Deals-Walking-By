...
import com.example.tejas.admin.DealsActivity;
...
public class DealsAdapter extends RecyclerView.Adapter<DealsAdapter.ProductViewHolder> {
    ...
    private List<DealStructure> mDealList;

    interface OnItemClicked{public void OnItemClickedHere(DealStructure dealStructure);}

    public DealsAdapter(Context context, List<DealStructure> dealList) {
        mContext = context;
        mDealList = dealList;
    }
...
//    private final View.OnClickListener mOnClickListener = new MyOnClickListener();
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
        final DealStructure mDealStructure = mDealList.get(position);
